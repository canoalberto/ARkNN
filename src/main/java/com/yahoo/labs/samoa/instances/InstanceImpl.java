...
public class InstanceImpl implements MultiLabelInstance {
    ...
    public InstanceImpl(InstanceImpl inst) {
        ...
        this.weightLabel = inst.weightLabel != null ? inst.weightLabel.clone() : null;
    ...
    @Override
    public double weightLabel(int label) {
        return weightLabel[label];
    }
    ...
    @Override
    public void createWeightLabel(int labels) {
        this.weightLabel = new double[labels];
        for(int i = 0; i < labels; i++)
        	this.weightLabel[i] = 1.0;
    }
    
    @Override
    public void setWeightLabel(int label, double weight) {
        this.weightLabel[label] = weight;
    }
